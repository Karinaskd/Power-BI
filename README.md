...
![Dashboard'as2](Dashboard'as2.png)

![Dashboard'as3](Dashboard'as3.png)
...
**Projekto peržiūra:** Norint peržiūrėti projektą, turite paspausti ant **Power BI projektas.pbix** ir jį atsisiųsti arba turite paspausti ant **Power BI projektas.pdf** failo ir jį peržiūrėti PDF formatu.

**Projekto atsisiuntimas:** Norint atsisiųsti projektą, turite paspausti ant **Power BI projektas.pbix** ir jį atsisiųsti arba klonuoti repositoriją naudodami Git.
